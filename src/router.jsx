...
import DetailBlogPage from "./pages/public/detailPage/detailBlog/DetailBlogPage";
...
export const router = createBrowserRouter([
    {
        ...
        children:[
            ...
            {path:ROUTER.PUBLIC.BLOG, element:<BlogPage/>},
            {path:ROUTER.PUBLIC.DETAIL_PRODUCT, element:<DetailProductPage/>},
            {path:ROUTER.PUBLIC.DETAIL_BLOG, element:<DetailBlogPage/>},
            ...
            {path:ROUTER.ADMIN.PRODUCTMANAGER, element:<ProductManage/>},
            {path:ROUTER.ADMIN.ORDERMANAGER, element:<OrderManage/>},
            {path:ROUTER.ADMIN.USERMANAGER, element:<UserManage/>},
