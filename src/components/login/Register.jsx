...
const Register = ({setShowRegister,showRegister,setShowLogin})=>{
    ...
    return (
        <div onClick={()=>setShowRegister(false)} className=" bg-[#a19a9a56] absolute top-0 bottom-0 left-0 right-0 z-20 flex justify-center">
            <div onClick={(e)=>{e.stopPropagation()  }} className={ `${showRegister===true ? " show " : ""} modelLogin fixed shadow-xl rounded-lg w-[90%] lg:w-[50%] min-h-[95%] md:min-h-[80%]  bg-white m-auto mt-2 mb-1 md:mt-10 pl-3 pr-3 pb-2`}>
